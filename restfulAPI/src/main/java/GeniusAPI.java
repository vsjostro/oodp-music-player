...
////                .asString();
        ...
        System.out.print("Enter in your song in the following format: \"Song Name (space) Artist Name\"");
        String userInput = scan.nextLine();
        System.out.println(userInput);

        HttpResponse<String> response = Unirest.get("https://genius.p.rapidapi.com/search?q=Tame%20Impala")
                .header("x-rapidapi-host", "genius.p.rapidapi.com")
                .header("x-rapidapi-key", "f5b9667b81mshe5ad2b60905317bp1db8d5jsn21ec6987e4bd")
                .asString();
